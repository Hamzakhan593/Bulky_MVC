...
namespace BulkyWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //populating the roles in dropdownlist
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Input.Role == Static_Details.Role_Company && Input.CompanyId == null)
                {
                    ModelState.AddModelError("Input.CompanyId", "Please select a company for Company role.");
                    return Page();
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    // assignnng role if user does not select roole from dropdownn then he will be assigned with customer
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, Static_Details.Role_Customer);
                    }


                    // Re-sign in to refresh role claims
                    ...
                    if (User.IsInRole(Static_Details.Role_Admin))
                    {
